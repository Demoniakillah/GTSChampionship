 ...
 */
final class Version20211011104509 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE driver_race CHANGE bonus bonus VARCHAR(9) DEFAULT NULL, CHANGE penalty penalty VARCHAR(9) DEFAULT NULL');
